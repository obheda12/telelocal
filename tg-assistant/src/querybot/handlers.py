...
async def handle_bd(
    ...
    prompt = (
        ...
        "Number each chat. For each one, give the full picture — who's waiting, "
        "what they need, relevant context from the conversation. A single chat can have "
        "multiple action items if the conversation warrants it — list them all. "
        "End each chat with a numbered <b>Action Items:</b> list stating exactly what I need to do. "
        "This section needs depth so I can act without going back to read the chat.\n\n"
        "UPDATES section:\n"
        ...
        "- <b>bold</b> for chat names and Action Items: labels\n"
